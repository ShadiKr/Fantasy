...
Lengthr = random.randint(1,4) #Chooses Random Length

Length = int(input("Between 1 and 4, 0 is random ")) #Allows The User to enter Length

if Length == 0: #If the value is 0, the code chooses a length randomly
    Length = Lengthr
...
CFirst_Name1 = ['Run','Un','Wa','Nu','Dian','Ra','Re','Dar','Aran','Ike','Jikro','Kilmon','Kano','Ax','Hal','Di','Da','De','Du','Kal','Ki','Ka','Ke','Ku','Lar','Qi','Dikilar','Do','Me','Jek','Ya','Bu','Ba','Uo','Ko','Po',"Kee'","Sol","Kai","Wad","Del","Wano","Kash"]
CFirst_Name2 = ['run','un','wa','nu','dian','ra','re','dar','aran','ike','jikro','kilmon','kano','ax','hal','di','da','de','du','kal','ki','ka','ke','ku','lar','qi','dikilar','do','me','jek','ya','bu','ba','uol','kol','pa',"keei","sol","kai","wad","del","war","kir"]

CLast_Name1 = ['Run','Un','Wa','Nu','Dian','Ra','Re','Dar','Aran','Ike','Jikro','Kilmon','Kano','Ax','Hal','Di','Da','De','Du','Kal','Ki','Ka','Ke','Ku','Lar','Qi','Dikilar','Do','Me','Jek','Ya','Bu','Ba','Uo','Ko','Po',"Kee'","Sol","Kai","Wad","Del","Wano","Kash"]
CLast_Name2 = ['run','un','wa','nu','dian','ra','re','dar','aran','ike','jikro','kilmon','kano','ax','hal','di','da','de','du','kal','ki','ka','ke','ku','lar','qi','dikilar','do','me','jek','ya','bu','ba','uol','kol','pa',"keei","sol","kai","wad"," del","war","kir"]
...
if Length == 3:
     print("Cardian Location: "+random.choice(CFirst_Name1)+random.choice(CFirst_Name2)+random.choice(CFirst_Name2)+random.choice(CFirst_Name2))

if Length == 4:
     print("Cardian Location: "+random.choice(CFirst_Name1)+random.choice(CFirst_Name2)+random.choice(CFirst_Name2)+random.choice(CFirst_Name2)+random.choice(CFirst_Name2))
